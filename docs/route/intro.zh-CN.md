...
本系统的路由基于插件 [Elegant Router](https://github.com/mufeng889/react-auto-route)，详细用法请查看插件文档。
...
联合类型 RouteKey 声明所有的路由 key，方便统一管理路由， 该类型由插件 [Elegant Router](https://github.com/mufeng889/react-auto-route) 根据 pages 下面的页面文件自动生成
