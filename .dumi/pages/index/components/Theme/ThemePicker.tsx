...
export const THEMES = {
  default:
    'https://gw.alipayobjects.com/zos/bmw-prod/ae669a89-0c65-46db-b14b-72d1c7dd46d6.svg',
  ...
  comic:
    'https://gw.alipayobjects.com/zos/bmw-prod/ed9b04e8-9b8d-4945-8f8a-c8fc025e846f.svg',
...
const ThemePicker: React.FC<ThemePickerProps> = (props) => {
  ...
  return (
    <Flex gap="large" wrap>
      {(Object.keys(THEMES) as (keyof typeof THEMES)[]).map<React.ReactNode>(
        (theme, index) => (
          <Flex
            vertical
            gap="small"
