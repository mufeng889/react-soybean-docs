...
${makeGrayPalette(index + 1)}
  ...
  text-align: left;
          ...
          &-item {
            ...
            &:first-child {
              border-radius: ${token.borderRadiusSM}px ${token.borderRadiusSM}px
                0 0;
            }
            ...
            &:hover {
              ...
              border-radius: 0 ${token.borderRadiusSM}px
                ${token.borderRadiusSM}px 0;
            }
          }
